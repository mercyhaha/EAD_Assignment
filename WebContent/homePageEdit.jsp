...
header {
    ...
    background-image: url(simple1.jpg);
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">SP IT!</a>
            </div>
    ...
    <div id="sliderFrame">
			<div id="slider">
				<img src="img/laptop1.jpg" alt="Luxurious Laptops" /> <img
					src="img/tablet1.jpg" alt="Tacky Tablets" /> <img src="img/mandk1.jpg"
					alt="Awesome Accessories" />
			</div>
		</div>
	</header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We are the utopia of all IT products!</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">We sell IT products!.</p>
                </div>
                 <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">You can contact us through mobile:</h4>
                    <p class="text-muted">6235 3535 <br/> 6222 6111</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">You can contact us by email:</h4>
                    <p class="text-muted">weluvead@justkidding.com <br/> wereallyluvead@justkidding.com</p>
                </div>
            </div>
        </div>
    </section>     
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We sell these:</h3>
                </div>
            </div>
            <div class="row">
                               
                <%@include file = "homePagePics.jsp" %>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/kj.png" class="img-responsive img-circle" alt="">
                        <h4>Ng Kaijie</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/plus.jpg" class="img-responsive img-circle" alt="">
                        
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/xb.png" class="img-responsive img-circle" alt="">
                        <h4>Ong Xin Bin</h4>
    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row1">
                <div class="col-lg-12">
                    <form action="verifyUser.jsp" method="post" id="contactForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Your Login/ID *" name="loginid">
